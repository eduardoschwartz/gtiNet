<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dam.aspx.cs" Inherits="UIWeb.Pages.dam" %>
    ...
    <form id="form1" runat="server">
        <div style="color: #3a8dcc;">
            ...
            <asp:Panel ID="Panel2" runat="server" ForeColor="Black" BorderColor="#3399FF" BorderStyle="Solid" BorderWidth="1px" Width="675px">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>&nbsp;&nbsp;
                         <asp:Label ID="Label1" runat="server" Text="Data de Vencimento:"></asp:Label>
                            &nbsp;
                        &nbsp;
                            <asp:TextBox ID="txtVencto" runat="server" BorderColor="#3399FF" BorderStyle="Solid" BorderWidth="1px" MaxLength="10" Width="70px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <br />
                <table border="0">
                    <tr>
                        ...
                        <td class="auto-style2">&nbsp;Digite o conteúdo da imagem
                            <br />
                            <asp:TextBox ID="txtimgcode" runat="server" OnClick="btConsultar_Click" ViewStateMode="Disabled" Width="147px"></asp:TextBox>
                            &nbsp;<asp:ImageButton ID="btConsultar" runat="server" ImageAlign="AbsBottom" ImageUrl="~/Images/icon_24_buscar_on.png" OnClick="btConsultar_Click" ToolTip="Pesquisar débitos em aberto" />
                        </td>
                        <td>
                            <asp:Button ID="btSelectAll" runat="server" OnClick="btSelectAll_Click" Text="Selecionar todos" Width="120px" />
                            <br />
                            <asp:Button ID="btSelectNone" runat="server" OnClick="btSelectNone_Click" Text="Desmarcar todos" Width="120px" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
            <br />
            <div style="color: #3a8dcc; width: 675px; height: 430px; overflow: auto;">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" HeaderStyle-BackColor="#3AC0F2" Width="990px" HeaderStyle-ForeColor="White">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
        ...
        <div style="width: 675px">
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="Pnlresumo" runat="server" BorderStyle="Solid" BorderWidth="1px" ForeColor="White" HorizontalAlign="Center">
                            <asp:Table ID="TableResumo" runat="server" CellPadding="5" HorizontalAlign="Right" Height="65px" BackColor="SandyBrown">
                                <asp:TableRow ID="RowExp" runat="server" ForeColor="Black">
                                    <asp:TableCell ID="TableCell6" runat="server" HorizontalAlign="Right" Width="150px">Taxa Expediente</asp:TableCell>
                                    <asp:TableCell ID="Expediente" runat="server" HorizontalAlign="Right" Width="70px"></asp:TableCell>
                                </asp:TableRow>
            ...
            <div>
                ...
                <br />
                <br />
                <asp:Button ID="btPrint" runat="server" align="left" colspan="2" OnClick="btPrint_Click" Text="Emissão de Guia" Width="150px" />
            </div>
        </div>
