...
namespace UIWeb {
    /// <summary>
    /// Summary description for CImage1
    /// </summary>
    public class CImage1 : IHttpHandler, System.Web.SessionState.IRequiresSessionState {
        ...
        public void RandomImage(string s, int width, int height) {
            this.text = s;
        ...
        public void ProcessRequest(HttpContext context) {
            ...
            String CodeImage = GenerateRandomCode();
            context.Session.Add("CaptchaImageText", CodeImage);

            // Create a CAPTCHA image using the text stored in the Session object.
            RandomImage(CodeImage, 300, 75);
            ...
            Dispose();
            //       RandomImage.CodigoImagem = CodeImage;
        }
